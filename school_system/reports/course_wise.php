...
// Excel Export: include detailed tables for each course
if(isset($_GET['export']) && $_GET['export'] == 'excel'){
    header("Content-Type: application/vnd.ms-excel");
    header("Content-Disposition: attachment; filename=course_wise_detailed.xls");
    ...
    if($courseResult->num_rows > 0){
        while($courseRow = $courseResult->fetch_assoc()){
            ...
            $detailsResult = $conn->query("
                SELECT s.Student_ID,a.Admission_ID, s.Full_Name, s.Admission_No, a.Academic_Year, a.Admission_Date,
            ...
            if($detailsResult->num_rows > 0){
                ...
                echo "<tr><td colspan='7' align='center'>No students found for this course</td></tr>";
            }
            echo "</table><br><br>";
        }
    }
    ...
    // Summary table
    echo "<h2>Summary: Total Students per Course</h2>";
    echo "<table border='1'>";
    echo "<tr><th>Course</th><th>Total Students</th></tr>";
...
<head>
    ...
    <style>
        ...
        .course-section h3 { margin-top: 0; }
...
<?php
if($courseResult->num_rows > 0){
    // Reset pointer for Excel export
...
<h2>Summary: Total Students per Course</h2>
